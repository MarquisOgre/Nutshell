...
export const ru: LangType = {
    ...
    /* Landing */
    'page.body.landing.header.button1': 'Профиль',
    'page.body.landing.header.button2': 'Войти',
    'page.body.landing.header.button3': 'Регистрация',
    'page.body.landing.header.button4': 'Главная',
    'page.body.landing.header.button5': 'Сообщество',
    'page.body.landing.header.button6': 'wiki',
    'page.body.landing.header.button7': 'Поддержка',

    'page.body.landing.marketInfo.title.text1': 'Добро пожаловать на Nutshell Exchange.',
    'page.body.landing.marketInfo.title.text2': 'Покупка, продажа и торги криптовалютными активами.',
    'page.body.landing.marketInfo.title.button': 'Начать торговать',

    'page.body.landing.platformInfo.item.first.value': '100+',
    'page.body.landing.platformInfo.item.first.title': 'Торговых пар до конца 2020 года',
    'page.body.landing.platformInfo.item.second.value': '4/8/5',
    'page.body.landing.platformInfo.item.second.title': 'Доступна техническая поддержка',
    'page.body.landing.platformInfo.item.third.value': '252',
    'page.body.landing.platformInfo.item.third.title': 'Стран имеют доступ к платформе',

    'page.body.landing.register.item.title': 'Опыт торгов не самое главное',
    'page.body.landing.register.item.text': 'Nutshell Exchange использует интуитивно понятный интерфейс с поддержкой отображения заявок в режиме реального времени, удобных графиков, историей заявок, а также удобным функционалом размещения заявки. Торговать можно начать уже в первый день.',
    'page.body.landing.register.item.button': 'регистрация',

    'page.body.landing.features.title': 'Nutshell Exchange features',
    'page.body.landing.features.features.item1.title': 'Биржа',
    'page.body.landing.features.features.item2.title': 'Типы заявок',
    'page.body.landing.features.features.item3.title': 'Удобный интерфейс',
    'page.body.landing.features.features.item4.title': 'Безопасность',
    'page.body.landing.features.features.item5.title': 'Сообщество',
    'page.body.landing.features.features.item6.title': 'Полноценный API',
    'page.body.landing.features.features.item1.text': 'Nutshell Exchange предлагает доступ к самым ликвидным парам на рынке. Мы даем возможность нашим клиентам доступ к ключевым парам для обмена Bitcoin, Ethereum, Litecoin, Ripple, Dash, PIVX, Zcoin, Tether, а также наиболее полпулряным альткоинам с минимальным шагом.',
    'page.body.landing.features.features.item2.text': 'Nutshell Exchange поддерживает различные типы заявок и стратегии ведения торгов. Узнайте больше о торговлен на основе алгоритмов в наших WIKI.',
    'page.body.landing.features.features.item3.text': 'Настройте торговый терминал под свои нужды: выберите тип отображения, цветовую тему, настройте уведомления удобным для Вас образом.',
    'page.body.landing.features.features.item4.text': 'Для нас крайне важны безопасность клиентских данных и средств. Свяжитесь с нами для получения более подробной информации об обеспечении безопасности наших клиентов.',
    'page.body.landing.features.features.item5.text': 'Присоединяйтесь к нашему Сообществу. Мы искренне верим в силу криптовалюты.',
    'page.body.landing.features.features.item6.text': 'Наш вебсокет позволяет с лёгкостью получить доступ к торговле в режиме реального времени. Наше API позволяет Вам использовать практически любой торговый бот без прохождения KYC.',

    'page.body.landing.tradeOnTheGo.item.title': 'Не важно где',
    'page.body.landing.tradeOnTheGo.item.text1': 'Наша платформа оптимизирована под любые мобильные устройства.',
    'page.body.landing.tradeOnTheGo.item.text2': 'Не требуется скачивать клиент или приложение.',
    'page.body.landing.tradeOnTheGo.item.text3': 'Вся мощь Nutshell Exchange в Вашей руке.',
    'page.body.landing.tradeOnTheGo.item.button': 'Давайте попробуем',

    'page.body.landing.startTrading.title': 'Начать торговать',
    'page.body.landing.startTrading.button1': 'Регистрация',
    'page.body.landing.startTrading.button2': 'Начать торговать',

    'page.body.landing.footer.exchange': 'Биржа',
    'page.body.landing.footer.wallets': 'Кошельки',
    'page.body.landing.footer.fees': 'Комиссии',
    'page.body.landing.footer.faq': 'ЧАВО',
    'page.body.landing.footer.support': 'Поддержка',
    'page.body.landing.footer.privacy': 'Политика конфиденциальности (англ.)',
    'page.body.landing.footer.wiki': 'Портал WIKI',
    'page.body.landing.footer.community': 'Сообщество',
    'page.body.landing.footer.buybtc': 'Покупка Bitcoin с помощью карты VISA/Mastercard',
    'page.body.landing.footer.status': 'Статус сервисов',
    'page.body.landing.footer.transperancy': 'Политика прозрачности (англ.)',
    'page.body.landing.footer.tos': 'Условия оказания услуг (англ.)',
    'page.body.landing.footer.rights': 'Nutshell Exchange 2020 © Все права защищены.',
