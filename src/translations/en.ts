...
export const en = {
    ...
    'page.body.landing.header.button4': 'home',
    'page.body.landing.header.button5': 'community',
    'page.body.landing.header.button6': 'wiki',
    'page.body.landing.header.button7': 'support',


    'page.body.landing.marketInfo.title.text1': 'Welcome to Nutshell Exchange.',
    ...
    'page.body.landing.platformInfo.item.first.title': 'Trading Pairs in 2020',
    'page.body.landing.platformInfo.item.second.value': '4/8/5',
    'page.body.landing.platformInfo.item.second.title': 'Support SLA',
    'page.body.landing.platformInfo.item.third.value': '252',
    'page.body.landing.platformInfo.item.third.title': 'Countries supported for operations',

    'page.body.landing.register.item.title': 'No matter your experience level',
    'page.body.landing.register.item.text': 'Nutshell Exchange offers an intuitive interface with real time orderbooks, charting tools, trade history, and a simple order process so you can trade from day one.',
    'page.body.landing.register.item.button': 'register',

    'page.body.landing.features.title': 'Nutshell Exchange platform features',
    ...
    'page.body.landing.features.features.item1.text': 'Nutshell Exchange offers the most liquid order book in the world, allowing users to easily exchange Bitcoin, Ethereum, EOS, Litecoin, Ripple, NEO and many other digital assets with minimal slippage.',
    'page.body.landing.features.features.item2.text': 'Nutshell Exchange offers a suite of order types to give traders the tools they need for every scenario. Discover more about our most advanced Algorithmic orders types.',
    ...
    'page.body.landing.tradeOnTheGo.item.text3': 'All the power of Nutshell Exchange cryptocurrency exchange, in the palm of your hand.',
    ...
    'page.body.landing.footer.wiki': 'Wiki',
    'page.body.landing.footer.community': 'Community',
    'page.body.landing.footer.buybtc': 'Buy Bitcoin',
    'page.body.landing.footer.status': 'Service status page',
	'page.body.landing.footer.transperancy': 'Transperancy Policy',
    'page.body.landing.footer.tos': 'Terms of Service',
    'page.body.landing.footer.rights': 'Nutshell Exchange © All rights reserved.',
